...
#####執行結果:
![GitHub Logo](/screen/results02-1.png)
...
function imageLoaded(){
    ...
    if(imgCnt==0){	
        ...
        // 建立主角	
        //----------
        sprite=new MySprite(100, 100, 0, 'normal');	
...
function control(keyCode){	
    if(keyCode==37){sprite.setDirection('left');}   //左	            
    if(keyCode==38){sprite.setDirection('up');}     //上			            
    if(keyCode==39){sprite.setDirection('right');}  //右            
    if(keyCode==40){sprite.setDirection('down');}   //下 
}
